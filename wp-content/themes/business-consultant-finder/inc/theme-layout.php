     ...
     <?php
      ...
      <div class="site-info">
    	<?php
                ...
                printf( esc_html__( 'Business Consultant Finder Theme By %1$s - Proudly powered by WordPress.', 'business-consultant-finder' ), '<a href="https://athemeart.com" target="_blank" rel="nofollow">athemeart</a>' );
                ?>
      </div>
